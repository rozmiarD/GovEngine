...
- Source/package version: `0.12.3a0`.
- Release label: `0.12.3-alpha`.
- PyPI package: `govengine==0.12.3a0` is the published current alpha package.
- SCLite integration: present through helper seams via source dependency `sclite-core>=1.0.2,<1.1`.
...
- PyPI publication: completed through `govengine==0.12.3a0`.
