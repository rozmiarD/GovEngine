...
GovEngine is an alpha package 0.16.3 (`0.16.3`) source line for deterministic governance-kernel contracts.
...
Current source line: `0.16.3`. Latest published PyPI line: `govengine==0.16.2`.
