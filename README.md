...
[![Package: govengine 0.16.7](https://img.shields.io/badge/package-govengine%200.16.7-blueviolet.svg)](https://pypi.org/project/govengine/0.16.7/)
...
GovEngine is an alpha package 0.16.7 (`0.16.7`) source line for deterministic governance-kernel contracts.
...
```bash
python -m pip install govengine==0.16.7
```
...
GovEngine repository at `0.16.7`.
