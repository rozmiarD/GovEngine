...
- Added `govengine.boundary` with serializable kernel/profile/runtime/SCLite ownership contracts, a Ravenclaw profile contract, and negative boundary validation for forbidden profile ownership claims.
