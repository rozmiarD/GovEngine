...
- Added `govengine.boundary` with serializable kernel/profile/runtime/SCLite ownership contracts, a machine-readable boundary report, a Ravenclaw profile contract, domain-profile conformance checks, boundary docs, and negative boundary validation for forbidden profile ownership or unknown consumed-surface claims.
