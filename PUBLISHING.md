...
- SCLite is published as the PyPI distribution `sclite-core`; GovEngine `0.2.0` depends on `sclite-core>=0.5.1,<0.6`; the previous published `0.1.7` release also depended on `sclite-core>=0.5.1,<0.6`.
