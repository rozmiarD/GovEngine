...
Current supported line: `govengine==0.16.11` with `sclite-core==1.0.9`.
...
- SCLite is published as the PyPI distribution `sclite-core`; the current supported GovEngine `0.16.x` package line depends on `sclite-core==1.0.9`.
