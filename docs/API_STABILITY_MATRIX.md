...
| alpha | govengine.policy | `CompiledPolicyPack`, `CompileResult`, `PolicyCompiler`, `PolicyConstraint`, `PolicyEngine`, `PolicyEnforcementPlan`, `PolicyObligation`, `PolicyRequest`, `PolicyRule`, `PolicyVerdict`, `RuntimeControlProjection`, `admit_policy_execution`, `compile_policy_pack`, `evaluate_policy`, `policy_enforcement_admission`, `policy_enforcement_admission_digest`, `policy_enforcement_plan_digest`, `policy_pack_digest`, `policy_verdict_digest`, `project_runtime_controls`, `validate_policy_enforcement_admission`, `validate_policy_enforcement_plan`, `validate_policy_request`, `validate_policy_verdict` | Deterministic policy request/verdict contracts, declarative rule compilation, fail-closed evaluation, GovEngine-owned enforcement plan, existing `GovAdmissionDecision` binding, canonical digests for GovEngine records, and domain-neutral runtime-control projection; hosts still own IO/enforcement and SCLite retains truth/canonicalization authority. |
