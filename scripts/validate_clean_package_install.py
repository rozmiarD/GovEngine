...
assert govengine.__version__ == '1.0.0rc3'
...
print('installed_surface_smoke_ok:govengine==1.0.0rc3:surfaces=7:policy_authoring=ok')
"""
    ...
    *,
    ...
    commands.extend(
        [
            ...
            [venv_python, 'scripts/validate_release_readiness.py'],
        ]
    )
    if dev:
